...
COYOTE_DIR = ROOT_DIR / "submodules" / "Coyote" / "examples" / "jigsaw_minus_nw" 

def create_parsers():

    parser = argparse.ArgumentParser(
            description="Run script for minus network setup.",
...
if args.command == 'proxy':
    ...
    if args.flash_bitstream:
        ...
        subprocess.run([SCRIPTS_RUN_DIR / "coyote-flash-bitstream.sh", "jigsaw_minus_nw"], check=True)
